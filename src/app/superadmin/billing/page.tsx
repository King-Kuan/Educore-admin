      ...
      <div className="card p-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            ...
            <div className="text-2xl font-bold text-gray-900">510,000 <span className="text-sm font-normal text-gray-400">Rwf/yr</span></div>
            <div className="text-sm text-gray-500 mt-1">170,000 Rwf/term × 3 terms = 510,000 Rwf/year</div>
          </div>
