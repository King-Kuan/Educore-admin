...
function LoginForm() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      router.push(redirect !== "/" ? redirect : getDashboard(userRole));
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input {...register("email")} type="email" autoComplete="email" placeholder="you@school.rw"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input {...register("password")} type={showPass ? "text" : "password"} autoComplete="current-password" placeholder="••••••••"
