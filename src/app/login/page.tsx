        ...
        <div className="card p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`
                    w-full pl-10 pr-4 py-2.5 text-sm rounded-md border
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`
                    w-full pl-10 pr-10 py-2.5 text-sm rounded-md border
                    focus:outline-none focus:ring-2 focus:ring-brand-600 focus:border-transparent
            ...
            <button
              ...
              className="
                w-full py-2.5 px-4 bg-brand-600 text-white text-sm font-semibold
                rounded-md shadow-sm hover:bg-brand-700 transition-colors
                disabled:opacity-50 disabled:cursor-not-allowed
                focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-600
              "
            >
              {isSubmitting ? (
